    ...
    if request.method == "POST":
        ...
        try:
            ...
            if existing_customer:
                ...
                username=inputed_username, password=inputed_password,phone_number=inputed_phone_number,e_mail=inputed_e_mail
                )
        ...
        try:
            existing_customer = models.Customer.objects.filter(phone_number=inputed_phone_number)
            if existing_customer:
                ...
                return HttpResponse(f"Hello {inputed_phone_number}, welcome to my site.")    
...
def create_task(request):
    if request.method=="POST":
        ...
        new_task= models.Task(name=inputted_task_name, description=inputted_task_description, customer_id=3)
        new_task.save()
